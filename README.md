...
> :memo: Since this product generates CRC models for the JavaScript language, I'm using the terms `class` and `object` synonymously to indicate objects with prototypal inheritance.
...
### 4.3. MVP 3.._n_: semantic analysis
...
## 6. Contributing to `eslint-plugin-crc`
