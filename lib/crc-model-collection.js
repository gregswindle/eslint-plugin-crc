...
/**
 Generates a collection of CrcModels based on source code strings or buffers.
 */
class CrcModelCollection {

    /**
     * Instantiate a new CrcModelCollection
     *
     * @param {string|buffer} code   The source code to be analyzed.
     * @param {object} config espree configuration.
     *
     * @returns {CrcModelCollection} A collection of CrcModels and their relationships with one another.
     */
    ...
    /**
     * Traverses the AST to identifier collaborators and associate them the objects that depend on them.
     *
     * @returns {void}
     */
  ...
  // REVIEW: This smells weird here. The CrcModelCollection is becoming a factory aggregator.
     ...
     * be used by other methods like {@link CrcModelCollection#find}. The order
