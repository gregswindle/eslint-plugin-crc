...
[sonar-code-smells-url]: https://sonarcloud.io/component_measures/metric/code_smells/list?id=gregswindle-eslint-plugin-crc&metric=code_smells
[sonar-cognitive-img]: https://sonarcloud.io/api/badges/measure?key=gregswindle-eslint-plugin-crc&metric=cognitive_complexity
[sonar-cognitive-url]: https://sonarcloud.io/component_measures/metric/cognitive_complexity/list?id=gregswindle-eslint-plugin-crc&metric=cognitive_complexity
[sonar-complexity-class-img]: https://sonarcloud.io/api/badges/measure?key=gregswindle-eslint-plugin-crc&metric=class_complexity
[sonar-complexity-class-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=class_complexity
[sonar-complexity-file-img]: https://sonarcloud.io/api/badges/measure?key=gregswindle-eslint-plugin-crc&metric=file_complexity
[sonar-complexity-file-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=file_complexity
[sonar-complexity-function-img]: https://sonarcloud.io/api/badges/measure?key=gregswindle-eslint-plugin-crc&metric=function_complexity
[sonar-complexity-function-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=function_complexity
[sonar-complexity-img]: https://sonarcloud.io/api/badges/measure?key=gregswindle-eslint-plugin-crc&metric=complexity
[sonar-complexity-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=complexity
[sonar-coverage-img]: https://sonarcloud.io/api/project_badges/measure?project=gregswindle-eslint-plugin-crc&metric=coverage
[sonar-coverage-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=coverage
...
[sonar-duplications-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=duplicated_lines_density
[sonar-gate-img]: https://sonarcloud.io/api/project_badges/measure?project=gregswindle-eslint-plugin-crc&metric=alert_status
[sonar-gate-url]: https://sonarcloud.io/dashboard?id=gregswindle-eslint-plugin-crc
[sonar-issues-img]: https://sonarcloud.io/api/badges/measure?key=gregswindle-eslint-plugin-crc&metric=blocker_violations
[sonar-issues-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=violations
...
[sonar-maintainability-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=new_maintainability_rating
[sonar-ncloc-img]: https://sonarcloud.io/api/project_badges/measure?project=gregswindle-eslint-plugin-crc&metric=ncloc
[sonar-ncloc-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=ncloc
...
[sonar-reliability-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=Reliability
[sonar-security-img]: https://sonarcloud.io/api/project_badges/measure?project=gregswindle-eslint-plugin-crc&metric=security_rating
[sonar-security-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=vulnerabilities
...
[sonar-tech-debt-url]: https://sonarcloud.io/component_measures/metric/sqale_index/list?id=gregswindle-eslint-plugin-crc&metric=sqale_index
[sonar-vulnerabilities-img]: https://sonarcloud.io/api/project_badges/measure?project=gregswindle-eslint-plugin-crc&metric=vulnerabilities
[sonar-vulnerabilities-url]: https://sonarcloud.io/component_measures?id=gregswindle-eslint-plugin-crc&metric=vulnerabilities
...
[eslint-logo]: https://raw.githubusercontent.com/gregswindle/eslint-plugin-crc/master/docs/img/logo-eslint.png
[eslint-url]: https://eslint.org/docs/user-guide/getting-started
[jest-logo]: https://raw.githubusercontent.com/gregswindle/eslint-plugin-crc/master/docs/img/logo-jest.png
